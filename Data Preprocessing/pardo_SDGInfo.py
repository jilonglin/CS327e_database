...
class Indicator(beam.DoFn):
    # change 29 columns of years to one column named 'Year' which has 29 rows representing each year
...
with beam.Pipeline('DirectRunner', options=opts) as p:
    ...
    indicator_pcoll = query_results | 'Extract year' >> beam.ParDo(Indicator())
    ...
    # make BQ records    
    qualified_table_name =  PROJECT_ID + ':dataset_1.SDGdata_year'
